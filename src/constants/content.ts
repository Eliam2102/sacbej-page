export const ContactInfo = {
  phone: '+52 999 827 0891',
  email: 'ecoturismo.sac.bej@gmail.com',
...
export const TeamContent = {
  ...
  cta: 'CONTÁCTANOS YA',
  images: {
    main: 'https://uvjwsdeyhuaievbeddql.supabase.co/storage/v1/object/public/sacbej/experiencias/grupal-sacbej.jpeg',
    secondary: 'https://uvjwsdeyhuaievbeddql.supabase.co/storage/v1/object/public/sacbej/experiencias/grupal2-sacbej.jpeg',
  }
}

export const AwardsContent = {
  title: 'Reconocimientos que <span class="highlight">avalan</span> nuestra excelencia',
  description: 'Nuestro compromiso con la calidad, la sostenibilidad y la experiencia excepcional del cliente nos ha valido el reconocimiento de las instituciones más prestigiosas del sector turístico en Yucatán.',
  stats: [
    { number: '2', label: 'Reconocimientos' },
    { number: '2025', label: 'Año actual' },
    { number: '100%', label: 'Certificados' },
  ]
}
